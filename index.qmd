...
::: band-dark
# Writer Profiles 
Each graph in a handwriting sample is matched to its most similar shape in the cluster template. By counting how often a writer uses graphs from each cluster, handwriter creates a unique profile of their handwriting style. This profile shows the writer's tendency to form shapes in particular ways.

![Writer Profiles from 2 Handwriting Samples in the CSAFE Handwriting Database](www/writer_profiles.png)
:::
