...
::: band-dark
![Get started with the [Quick Start Guide](get-started/quick-start-guide.html).](www/quick_start.png)
:::
...
::::::::: band-light
# Which Scenario Fits Your Handwriting Samples?
...
::: text-content-66
## Path 2 - Compare a QD to Known Writing Samples
...
[Get started](get-started.html) or [learn more](learn-more.html) about the methods.
:::::::::
